 ...
 */
?>
<link rel="stylesheet" href="<?php echo URL_THIRD_THEMES ?>calendar/css/updates.css"/>
...
<div class="box table-list-wrap">
    <div class="tbl-ctrls">
        ...
        <fieldset class="tbl-search right">
            <a class="btn tn action" target="_blank" href="https://accounts.solspace.com/">
                Get Latest Version
            </a>
        </fieldset>
