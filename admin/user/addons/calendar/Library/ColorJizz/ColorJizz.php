...
namespace Solspace\Addons\Calendar\Library\ColorJizz;

use Solspace\Addons\Calendar\Library\ColorJizz\Formats\CIELab;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\CIELCh;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\CMY;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\CMYK;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\Hex;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\HSV;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\RGB;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\XYZ;
use Solspace\Addons\Calendar\Library\ColorJizz\Formats\Yxy;
...
abstract class ColorJizz
{
    ...
    public function sweetspot($includeSelf = false)
    {
        ...
        $colors[1] = new HSV(
            $colors[0]->hue,
            round($colors[0]->saturation * 0.3),
            min(round($colors[0]->value * 1.3), 100)
        );
        $colors[3] = new HSV(($colors[0]->hue + 300) % 360, $colors[0]->saturation, $colors[0]->value);
        $colors[2] = new HSV(
            $colors[1]->hue,
            min(round($colors[1]->saturation * 1.2), 100),
            min(round($colors[1]->value * 0.5), 100)
        );
