<div class="addon_tag_group" id="solspace_tag_field_<?=$field_id?>">
	...
	<?php if ($explode_separator):?>
		...
		<?php endif;?>
			...
			<div class="tag_clear"></div>
	<?php endif;?>
			<div class="addon_tag_input_area">
				...
				<div class="addon_tag_current_tags tag_clear">
