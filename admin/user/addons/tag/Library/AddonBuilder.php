...
trait AddonBuilder
{
     ...
     * @var string
     */
    public static $class_version        = '2.0.1';
    ...
    protected function mcp_view($options = array())
    {
        ...
        $header_name = ucwords(str_replace('_', ' ', $this->lower_name));
    ...
    public function universal_pagination($input_data)
    {
        ...
        } elseif ($use_query_strings === false) {
        ...
        if (REQ == 'CP' or
            ...
            // ----------------------------------------
            $input_data['limit'] = (empty($input_data['limit'])) ? 1 : $input_data['limit'];
    ...
    public function setup_unit_test_mode($test_mock = false, $do_actions = true)
    {
        ...
        } elseif (is_string($test_mock) && class_exists($test_mock)) {
