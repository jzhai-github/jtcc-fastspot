<div class="panel box ee<?=$ee_ver?>">
    <h1 class="panel-heading">Purge Hit Counter</h1>

    <div class="panel-body txt-wrap">
    ...
    echo form_submit(array('name' => 'submit', 'value' => ee()->lang->line('btn_purge_detours'), 'class' => 'btn submit action'));
    echo form_close();
?>
    </div>
</div>
