<?php
/**
 * EEHarbor PHAR Loader for SafeHarbor
 ...
 * @link       https://eeharbor.com/safeharbor
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'safeharbor/safeharbor.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/safeharbor';

        $namespace = 'EEHarbor\Safeharbor';
