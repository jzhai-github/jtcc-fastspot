;(function($, global){
	...
	*/
	...
	function setFieldEvents ($parent)
	{
		...
		var $current_tags			= $('div.addon_tag_current_tags', $parent);
		//var $new_tags_section_name	= $('div.addon_tag_new_tags .tag_section_name', $parent);
		var $new_tags_section_data	= $('div.addon_tag_new_tags .tag_section_data', $parent);
		var $suggest_tags			= $('div.addon_tag_suggest_tags', $parent);
		var $suggest_tags_holder	= $('div.tag_section_data', $suggest_tags);
		var $top_tags				= $('div.addon_tag_top_tags', $parent);
	...
	$(function(){
		...
		$('div.addon_tag_group').each(function(){
			setFieldEvents($(this));
		});
